...
exports.userSignup = exports.logout = exports.login = void 0;
...
var userSignup = /*#__PURE__*/function () {
  var _ref2 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee2(name, email, photo, Password, Confirmpassword) {
    var res;
  ...
  return function userSignup(_x3, _x4, _x5, _x6, _x7) {
...
var updateData = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(password_current, password, password_confirm) {
    var res;
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
...
var loOutBtn = document.querySelector('.nav__el--logout'); // const userDataForm = document.querySelector('.form-user-data')
...
if (loOutBtn) {
  loOutBtn.addEventListener('click', _Login.logout);
} // if(userDataForm){
...
if (SignForm) {
  SignForm.addEventListener('submit', function (event) {
    ...
    (0, _Login.userSignup)(name, email, photo, Password, ConfirmPassword);
  });
}
...
if (userPasswordForm) {
  userPasswordForm.addEventListener('submit', function (e) {
    ...
    (0, _updateSetting.updateData)(password_current, password, password_confirm);
  });
}
